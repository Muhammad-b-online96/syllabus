    ...
    <footer className="border-t py-8 bg-muted/50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div>
            <h3 className="text-lg font-semibold mb-4">CurriculumPlanner</h3>
            <p className="text-sm text-muted-foreground">
              A modern platform for curriculum planning and management designed for educators.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="#" className="text-sm text-muted-foreground hover:text-foreground">API</Link>
                </li>
              </ul>
            </div>
            <div>
        ...
        <div className="mt-8 border-t border-muted pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-xs text-muted-foreground">
            &copy; {year} CurriculumPlanner. All rights reserved.
          </p>
